...
## 캐릭터 이름(character name)의 글자에서 기본으로 사용됩니다.
...
## 인-게임 글자에 사용됩니다.
define gui.text_font = "fonts/gyeonggi_title_bold.ttf"

## 캐릭터의 이름에 사용됩니다.
define gui.name_text_font = "fonts/gyeonggi_title_bold.ttf"

## 인터페이스에 사용됩니다.
define gui.interface_text_font = "fonts/gyeonggi_title_medium.ttf"
...
## 캐릭터 이름과 대사 사이의 가로 구분선 설정입니다. (textbox_BA.png 내장)
define gui.say_line_xpos = 185
define gui.say_line_ypos = 124
define gui.say_line_width = 1549
define gui.say_line_height = 3
define gui.say_line_color = "#6E7173"
...
define gui.choice_button_width = 1339
define gui.choice_button_height = 97
...
define gui.choice_button_text_hover_color = gui.choice_button_text_idle_color
...
init python:
    ...
    def small():
        ...
        gui.say_line_xpos = 120
        gui.say_line_ypos = 65
        gui.say_line_width = 1665
